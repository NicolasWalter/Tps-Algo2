...
Conj<Posicion> Campus::IngresosMasCercanos(Posicion pos){
	Conj<Posicion> nuevo;
	Posicion ingSup = Posicion(pos.x, 1);
	Posicion ingInf = Posicion(pos.x, filas);
