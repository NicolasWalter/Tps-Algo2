...
\begin{Interfaz}
  ...
  [$\bigO(R)$]
  [R es el tamaño de la restriccion mas grande vigente en las sendas de la ciudad.]
  []  
...
\\
a y c son 2 porque realizo dos llamadas recursivas (uno al subarbol derecho y otra al izquierdo) y cada uno de estos tiene la mitad del tamaño del original.
