...
\begin{algorithm}\phantom{[H]}
\begin{algorithmic}[1]
\Function {\textsc{$i$VecinosComunes}}{\paramIn{e}{estr}, \paramIn{p}{posicion}, \paramIn{p2}{posicion}}{$\disFlecha$ res : conj(posicion)} \Comment{$\Ode{}$}
...
\begin{algorithm}\phantom{[H]}
\begin{algorithmic}[1]
\Function {\textsc{$i$VecinosValidos}}{\paramIn{e}{estr}, \paramIn{ps}{conj(posicion)}}{$\disFlecha$ res : conj(posicion)} \Comment{$\Ode{}$}
    \State  var conj(posicion) nuevo $\gets$ vacio() 
